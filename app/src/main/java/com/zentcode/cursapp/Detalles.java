...
public class Detalles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DATA.add(new Data_Detalles(1, 0, "Feria del productor al consumidor en la Facultad de Agronomía",
        ...
        DATA.add(new Data_Detalles(1, 1, "Inseminación artificial",
                "Las mejores propuestas gastronómicas y renovados eventos, pasá una tarde diferente rodeada de más de 120 productores, economía social y solidaria y comercio justo, en un espacio verde pensado para relajarse",
                "10 de marzo - 13 de marzo / 8:00 a 11:00 hs", "100.000 Gs",
                "Facultad de Agronomía UNA", "0981200100"));

        DATA.add(new Data_Detalles(1, 2, "XIX Seminario Latinoamericano y del Caribe de Ciencia y Tecnología de los Alimentos",
                "Las mejores propuestas gastronómicas y renovados eventos, pasá una tarde diferente rodeada de más de 120 productores, economía social y solidaria y comercio justo, en un espacio verde pensado para relajarse",
                "10 de marzo - 13 de marzo / 8:00 a 11:00 hs", "100.000 Gs",
                "Facultad de Agronomía UNA", "0981200100"));

        DATA.add(new Data_Detalles(2, 0, "Diseño Gráfico",
                "Las mejores propuestas gastronómicas y renovados eventos, pasá una tarde diferente rodeada de más de 120 productores, economía social y solidaria y comercio justo, en un espacio verde pensado para relajarse",
                "10 de marzo - 13 de marzo / 8:00 a 11:00 hs", "100.000 Gs",
                "SNPP", "0981200100"));

        DATA.add(new Data_Detalles(2, 1, "Encuadernación",
                "Las mejores propuestas gastronómicas y renovados eventos, pasá una tarde diferente rodeada de más de 120 productores, economía social y solidaria y comercio justo, en un espacio verde pensado para relajarse",
                "10 de marzo - 13 de marzo / 8:00 a 11:00 hs", "100.000 Gs",
                "SNPP", "0981200100"));
        ...
        if(position_grid ==1 && position_list ==0){position_detalle=0;}
        else if(position_grid ==1 && position_list ==1){position_detalle=1;}
        else if(position_grid ==1 && position_list ==2){position_detalle=2;}
        else if(position_grid ==2 && position_list ==0){position_detalle=3;}
        else if(position_grid ==2 && position_list ==1){position_detalle=4;}
